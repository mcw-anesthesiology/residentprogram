...
@section("body")
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 reset-password-container">
			<a href="{{ config('auth.external_auth') ? config('auth.external_auth_reset_url') : '/password/reset' }}" role="button" class="btn btn-lg btn-default btn-block">Forgot Password?</a>
		</div>
	</div>
@stop
