...
<p>
	You have received a new evaluation request: <a href="{{ url("/evaluate/".$evaluationHash) }}">Dr. {{ $subjectLast }}, {{ $formTitle }}</a>. Please complete it at your earliest convenience. This link will expire on <b>{{ $hashExpires }}</b>.
</p>
<p>
...
<p>
	If you have any questions or comments about the system, you can contact me directly at <a href="mailto:{{ env('ADMIN_EMAIL') }}">{{ env('ADMIN_EMAIL') }}</a>.
</p>
