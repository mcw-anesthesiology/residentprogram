...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.FORM_BUILDER_VM = undefined;
	...
	var FORM_BUILDER_VM = exports.FORM_BUILDER_VM = new _vue2.default({
		el: '#form-builder',
		data: function data() {
			return {
				oldFormContents: {}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormBuilderInstruction = __webpack_require__(68);
	
	var _FormBuilderInstruction2 = _interopRequireDefault(_FormBuilderInstruction);
	
	var _FormBuilderQuestion = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormBuilderOption = __webpack_require__(74);
	
	var _FormBuilderOption2 = _interopRequireDefault(_FormBuilderOption);
	
	var _SelectTwo = __webpack_require__(77);
	...
	exports.default = {
		...
		computed: {
			...
			traineeForm: function traineeForm() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('div', {
	    staticClass: "container-fluid form-question form-block",
	    attrs: {
	      "id": questionId
	    }
	  }, [_m(0), " ", _h('div', {
	  ...
	  }, [_m(2), " ", _l((allCompetencies), function(competency) {
	    return _h('option', {
	      domProps: {
	        "value": competency.id,
	  ...
	  }, [_m(3), " ", _m(4), " ", _m(5), " ", _m(6), " ", _m(7)])])]), " ", _h('div', {
	    staticClass: "col-md-1"
	  }, [_h('label', {
	    staticClass: "containing-label"
	  }, ["\n\t\t\t\tRequired\n\t\t\t\t", _h('input', {
