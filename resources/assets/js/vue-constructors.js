...
function fetchUserGroups() {
	...
	return fetch('/users', {
		...
		var userGroups = Object.values(groups);
...
function fetchFormGroups() {
	...
	return fetch('/forms', {
		...
		var formGroups = Object.values(groups);
		formGroups.map(function (group) {
			group.children.sort(sortSelect2Objects);
		});
...
var string = __webpack_require__(105);
...
var elementUtilsMaker       = __webpack_require__(133);
var listenerHandlerMaker    = __webpack_require__(136);
var idGeneratorMaker        = __webpack_require__(134);
var idHandlerMaker          = __webpack_require__(135);
var reporterMaker           = __webpack_require__(137);
var browserDetector         = __webpack_require__(68);
var batchProcessorMaker     = __webpack_require__(99);
var stateHandler            = __webpack_require__(138);

//Detection strategies.
var objectStrategyMaker     = __webpack_require__(131);
var scrollStrategyMaker     = __webpack_require__(132);
...
var _FormBuilder = __webpack_require__(151);
...
var _BootstrapButtonInput = __webpack_require__(150);

var _BootstrapButtonInput2 = _interopRequireDefault(_BootstrapButtonInput);

var _ChartjsChart = __webpack_require__(72);
...
var _elementResizeDetector = __webpack_require__(70);
...
var _FormBuilderInstruction = __webpack_require__(152);

var _FormBuilderInstruction2 = _interopRequireDefault(_FormBuilderInstruction);

var _FormBuilderQuestion = __webpack_require__(154);
...
var _FormBuilderOption = __webpack_require__(153);

var _FormBuilderOption2 = _interopRequireDefault(_FormBuilderOption);

var _SelectTwo = __webpack_require__(158);
...
var _TraineeReport = __webpack_require__(160);

var _TraineeReport2 = _interopRequireDefault(_TraineeReport);

var _FormReport = __webpack_require__(189);
...
var _AggregateReport = __webpack_require__(149);

var _AggregateReport2 = _interopRequireDefault(_AggregateReport);

var _ReportDate = __webpack_require__(156);

var _ReportDate2 = _interopRequireDefault(_ReportDate);

var _StatsReport = __webpack_require__(159);
...
exports.default = {
	...
	created: function created() {
		...
		fetchFormGroups().then(function (groupedForms) {
			_this.groupedForms = groupedForms;
		}).catch(function (err) {
			console.error(err);
		});
	},
	...
	methods: {
		runReport: function runReport() {
			...
			fetch('/report/form', {
				...
				_this2.report = Object.assign({}, _this2.report, report);
			}).catch(function (err) {
				console.error(err);
			});
		},
...
__vue_options__.__file = "/home/mischka/projects/residentprogram/resources/assets/js/vue-components/FormReport.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-72bf01c2", __vue_options__)
  } else {
    hotAPI.reload("data-v-72bf01c2", __vue_options__)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-72bf01c2", module.exports)
  }
}
