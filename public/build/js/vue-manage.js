...
function createManageMilestonesCompetencies(el, propsData) {
	...
	return new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
		...
		methods: {
			ucfirst: __WEBPACK_IMPORTED_MODULE_5__modules_utils_js__["b" /* ucfirst */],
			fetchMilestones: function fetchMilestones() {
				...
				return fetch('/milestones?' + query, {
					method: 'GET',
					headers: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__modules_utils_js__["c" /* getFetchHeaders */])(),
					credentials: 'same-origin'
				}).then(__WEBPACK_IMPORTED_MODULE_5__modules_utils_js__["d" /* jsonOrThrow */]).then(function (milestones) {
			...
			fetchCompetencies: function fetchCompetencies() {
				...
				return fetch('/competencies?' + query, {
					...
					headers: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__modules_utils_js__["c" /* getFetchHeaders */])(),
					credentials: 'same-origin'
				}).then(__WEBPACK_IMPORTED_MODULE_5__modules_utils_js__["d" /* jsonOrThrow */]).then(function (competencies) {
			...
			saveMilestoneOrder: function saveMilestoneOrder() {
				...
				}).then(__WEBPACK_IMPORTED_MODULE_5__modules_utils_js__["d" /* jsonOrThrow */]).then(function (results) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__merit_js__ = __webpack_require__(483);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vue_components_JsonSchemaEditor_vue__ = __webpack_require__(531);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vue_components_JsonSchemaEditor_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__vue_components_JsonSchemaEditor_vue__);
/* harmony export (immutable) */ __webpack_exports__["a"] = createManageMerit;




function createManageMerit(el) {
	return new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
		el: el,
		props: {},
		data: function data() {
		...
		components: {
			JsonSchemaEditor: __WEBPACK_IMPORTED_MODULE_1__vue_components_JsonSchemaEditor_vue___default.a
		}
	});
}
...
module.exports = {
  ...
  ucs2length: __webpack_require__(504),
...
var resolve = __webpack_require__(486);
...
var url = __webpack_require__(89)
  , equal = __webpack_require__(487)
  , util = __webpack_require__(484)
  , SchemaObject = __webpack_require__(488);
...
var json = typeof JSON !== 'undefined' ? JSON : __webpack_require__(527);
...
var compileSchema = __webpack_require__(502)
  , resolve = __webpack_require__(486)
  , Cache = __webpack_require__(498)
  , SchemaObject = __webpack_require__(488)
  , stableStringify = __webpack_require__(495)
  , formats = __webpack_require__(501)
  , rules = __webpack_require__(503)
  , $dataMetaSchema = __webpack_require__(496)
  , patternGroups = __webpack_require__(524)
  , util = __webpack_require__(484)
  , co = __webpack_require__(494);
...
Ajv.prototype.compileAsync = __webpack_require__(500);
var customKeyword = __webpack_require__(523);
Ajv.prototype.addKeyword = customKeyword.add;
Ajv.prototype.getKeyword = customKeyword.get;
Ajv.prototype.removeKeyword = customKeyword.remove;

var errorClasses = __webpack_require__(485);
...
function addDraft6MetaSchema(self) {
  var $dataSchema;
  if (self._opts.$data) {
    $dataSchema = __webpack_require__(525);
    self.addMetaSchema($dataSchema, $dataSchema.$id, true);
  }
  if (self._opts.meta === false) return;
  var metaSchema = __webpack_require__(526);
...
module.exports = {
  '$ref': __webpack_require__(520),
  allOf: __webpack_require__(505),
  anyOf: __webpack_require__(506),
  const: __webpack_require__(507),
  contains: __webpack_require__(508),
  dependencies: __webpack_require__(510),
  'enum': __webpack_require__(511),
  format: __webpack_require__(512),
  items: __webpack_require__(513),
  maximum: __webpack_require__(489),
  minimum: __webpack_require__(489),
  maxItems: __webpack_require__(490),
  minItems: __webpack_require__(490),
  maxLength: __webpack_require__(491),
  minLength: __webpack_require__(491),
  maxProperties: __webpack_require__(492),
  minProperties: __webpack_require__(492),
  multipleOf: __webpack_require__(514),
  not: __webpack_require__(515),
  oneOf: __webpack_require__(516),
  pattern: __webpack_require__(517),
  properties: __webpack_require__(518),
  propertyNames: __webpack_require__(519),
  required: __webpack_require__(521),
  uniqueItems: __webpack_require__(522),
  validate: __webpack_require__(493)
};
...
var MissingRefError = __webpack_require__(485).MissingRef;
...
var resolve = __webpack_require__(486)
  , util = __webpack_require__(484)
  , errorClasses = __webpack_require__(485)
  , stableStringify = __webpack_require__(495);

var validateGenerator = __webpack_require__(493);

/**
 * Functions below are used inside compiled validations function
 */

var co = __webpack_require__(494);
var ucs2length = util.ucs2length;
var equal = __webpack_require__(487);
...
var ruleModules = __webpack_require__(499)
  , toHash = __webpack_require__(484).toHash;
...
var customRuleCode = __webpack_require__(509);
...
exports.parse = __webpack_require__(528);
exports.stringify = __webpack_require__(529);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ajv__ = __webpack_require__(497);
...
/* harmony default export */ __webpack_exports__["default"] = {
	...
	methods: {
		isSchemaValid: function isSchemaValid(merit) {
			if (this.schemaValidator) return this.schemaValidator(merit);
