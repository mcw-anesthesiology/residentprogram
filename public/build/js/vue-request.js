...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_indefinite__ = __webpack_require__(653);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__ = __webpack_require__(6);
	...
	return new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
		...
		computed: {
			...
			evaluatorOptions: function evaluatorOptions() {
				return Object(__WEBPACK_IMPORTED_MODULE_6__modules_utils_js__["r" /* groupUsers */])(this.filteredEvaluators);
			},
			subjectOptions: function subjectOptions() {
				return Object(__WEBPACK_IMPORTED_MODULE_6__modules_utils_js__["r" /* groupUsers */])(this.filteredSubjects);
			},
			...
			formOptions: function formOptions() {
				return Object(__WEBPACK_IMPORTED_MODULE_6__modules_utils_js__["p" /* groupForms */])(this.subjectForms);
			},
				...
				if (this.user.type === 'admin' && this.schedule) {
					...
					switch (form.evaluation_period_type) {
						case 'year':
							...
							break;
						case 'semester':
							dates = Object(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["semestersInAcademicYear"])().filter(function (semester) {
