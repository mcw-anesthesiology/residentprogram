...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_EvaluationDataTable_vue__ = __webpack_require__(221);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5eaa9cb0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_EvaluationDataTable_vue__ = __webpack_require__(223);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DataTable_vue__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__StartEndDate_vue__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_localforage__ = __webpack_require__(222);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vue_components_EvaluationDataTable_vue__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vue_components_SelectTwo_vue__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_indefinite__ = __webpack_require__(679);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__ = __webpack_require__(29);
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
	...
	return new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
		...
		data: function data() {
			...
			return {
				...
				schedule: false,
				requestDate: Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["isoDateString"])(new Date()),
		...
		computed: {
			flatpickrOptions: function flatpickrOptions() {
				var academicYear = Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["academicYearForDate"])(new Date());
			...
			required: function required() {
				...
				if (this.requestType === 'resident' && this.user.type === 'faculty' || this.requestType === 'staff' && this.user.type === 'staff' || this.requestType === 'faculty' && this.user.type === 'resident' || this.requestType === 'app' && this.user.type === 'faculty' || this.requestType === 'intern360' && this.user.type === 'resident' && ['ca-1', 'ca-2', 'ca-3', 'fellow'].includes(this.user.training_level) || this.requestType === 'self') required.evaluatorId = false;
			...
			filteredEvaluators: function filteredEvaluators() {
				var _this2 = this;

				if (!this.evaluators) return;
				if (!this.evaluatorFilter) return this.evaluators[0];

				return this.evaluators[0].filter(function (user) {
					return _this2.evaluatorFilter.includes(user.id);
				});
			},
			filteredSubjects: function filteredSubjects() {
				...
				if (!this.subjectFilter) return this.subjects[0];

				return this.subjects[0].filter(function (user) {
					return _this3.subjectFilter.includes(user.id);
				});
			},
			filteredForms: function filteredForms() {
				...
				if (!this.formFilter) return this.forms;

				return this.forms.filter(function (form) {
					return _this4.formFilter.includes(form.id);
				});
			},
			evaluatorOptions: function evaluatorOptions() {
				return Object(__WEBPACK_IMPORTED_MODULE_7__modules_utils_js__["t" /* groupUsers */])(this.filteredEvaluators);
			},
			subjectOptions: function subjectOptions() {
				return Object(__WEBPACK_IMPORTED_MODULE_7__modules_utils_js__["t" /* groupUsers */])(this.filteredSubjects);
			},
			...
			formOptions: function formOptions() {
				return Object(__WEBPACK_IMPORTED_MODULE_7__modules_utils_js__["r" /* groupForms */])(this.subjectForms);
			},
			evaluationDate: function evaluationDate() {
				if (this.useCustomEvaluationDate && this.customEvaluationDate) {
					try {
						...
						Object(__WEBPACK_IMPORTED_MODULE_6__modules_errors_js__["c" /* logError */])('Error with custom eval date, using non-custom', e);
					}
				}
			...
			evaluationDates: function evaluationDates() {
				...
				var form = this.forms.find(function (form) {
					return form.id === Number(_this5.formId);
				});
				...
				if (this.user.type === 'admin' && this.schedule) {
					...
					switch (form.evaluation_period_type) {
						case 'year':
							dates = [Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["currentYear"])()];
							break;
						case 'semester':
							dates = Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["semestersInAcademicYear"])().filter(function (semester) {
								return semester.startDate <= requestDate;
							});
							break;
						case 'quarter':
							dates = Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["quartersInAcademicYear"])().filter(function (quarter) {
								return quarter.startDate <= requestDate;
							});
							break;
						case 'month':
						default:
							dates = Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["monthsInAcademicYear"])().filter(function (month) {
					...
					switch (form.evaluation_period_type) {
						case 'year':
							...
							if (today.month() === 6 && form.type === 'faculty') {
								dates.unshift(Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["lastYear"])());
							}
							break;
						case 'semester':
							dates = Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["semestersInAcademicYear"])().filter(function (semester) {
								return semester.startDate <= today && semester.endDate >= threeMonthsAgo;
							});
							break;
						case 'quarter':
							dates = Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["quartersInAcademicYear"])().filter(function (quarter) {
			...
			evaluationDateOptions: function evaluationDateOptions() {
				if (this.evaluationDates) return this.evaluationDates.map(function (date) {
					return {
						id: JSON.stringify(Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["isoDateStringObject"])(date)),
						text: Object(__WEBPACK_IMPORTED_MODULE_8__modules_date_utils_js__["renderDateRange"])(date.startDate, date.endDate)
					};
				});
			},
			...
			pendingFacultyEvalsConfig: function pendingFacultyEvalsConfig() {
				...
				return {
					...
					columns: [{ data: 'url', render: __WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["m" /* renderEvaluatorEvalUrl */] }, { data: 'subject.full_name' }, { data: 'form.title' }, {
						data: null,
						render: Object(__WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["j" /* renderDateRangeCell */])('evaluation_date_start', 'evaluation_date_end'),
						createdCell: Object(__WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["b" /* createDateRangeCell */])('evaluation_date_start', 'evaluation_date_end')
					}, { data: 'request_date', render: __WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["k" /* renderDateTimeCell */], createdCell: __WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["c" /* createDateTimeCell */] }, { data: null, render: function render(evaluation) {
							if (evaluation.requested_by_id === _this6.user.id) return '<button class="btn btn-danger btn-xs cancel-eval-button" ' + 'data-id="' + evaluation.id + '"><span class="glyphicon glyphicon-remove"></span> ' + 'Cancel</button>';
			...
			completeFacultyEvalsConfig: function completeFacultyEvalsConfig() {
				return {
					...
					columns: [{ data: 'url', render: __WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["m" /* renderEvaluatorEvalUrl */] }, { data: 'subject.full_name' }, { data: 'form.title' }, {
						...
						render: Object(__WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["j" /* renderDateRangeCell */])('evaluation_date_start', 'evaluation_date_end'),
						createdCell: Object(__WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["b" /* createDateRangeCell */])('evaluation_date_start', 'evaluation_date_end')
					}, { data: 'request_date', render: __WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["k" /* renderDateTimeCell */], createdCell: __WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["c" /* createDateTimeCell */] }, { data: 'complete_date', render: __WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["k" /* renderDateTimeCell */], createdCell: __WEBPACK_IMPORTED_MODULE_9__modules_datatable_utils_js__["c" /* createDateTimeCell */] }],
					order: [[0, 'desc']],
					createdRow: function createdRow(row) {
						$(row).addClass('view-evaluation');
					}
		...
		mounted: function mounted() {
			if (this.filteredEvaluators && this.filteredEvaluators.length === 1 && this.required.evaluatorId) this.evaluatorId = this.filteredEvaluators[0].id;

			if (this.filteredSubjects && this.filteredSubjects.length === 1 && this.required.subjectId) this.subjectId = this.filteredSubjects[0].id;

			if (this.filteredForms && this.filteredForms.length === 1 && this.required.formId) this.formId = this.filteredForms[0].id;
		},
		...
		watch: {
			allowMultiple: function allowMultiple(_allowMultiple) {
				...
				Object.keys(_allowMultiple).map(function (field) {
					if (_allowMultiple[field] && !Array.isArray(_this7[field])) _this7[field] = [_this7[field]];else if (!_allowMultiple[field] && Array.isArray(_this7[field])) _this7[field] = _this7[field][0];
				});
			},
			...
			evaluationDateOptions: function evaluationDateOptions(options) {
				...
				if (this.evaluationDateJson) {
					if (!options) this.evaluationDateJson = null;
				...
				if (Array.isArray(this.evaluationDateJson)) {
					var newJson = options.filter(function (_ref) {
						var id = _ref.id;
						return _this8.evaluationDateJson.includes(id);
					}).map(function (_ref2) {
						var id = _ref2.id;
						return id;
					});
					...
					if (!options.some(function (_ref3) {
						var id = _ref3.id;
						return id === _this8.evaluationDateJson;
		...
		methods: {
			...
			checkSubmit: function checkSubmit(event) {
				...
				Object.keys(this.required).map(function (field) {
					_this9.checkField(field, _this9.fieldNouns[field]);
				});
...
function getSearchParam(prop) {
	...
	return params.has(prop) ? params.get(prop) : null;
}

function getSearchFilter(prop) {
	var params = new URLSearchParams(window.location.search);
	return params.has(prop) ? params.getAll(prop) : null;
}

function mapNumbersIfExists(arr) {
	return arr ? arr.map(function (val) {
		return Number(val);
	}) : null;
}
