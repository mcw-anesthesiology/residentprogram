...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vue_components_SelectTwo_vue__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_indefinite__ = __webpack_require__(358);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__ = __webpack_require__(21);
	...
	return new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
		...
		data: function data() {
			...
			return {
				...
				schedule: false,
				requestDate: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["isoDateString"])(new Date()),
		...
		computed: {
			flatpickrOptions: function flatpickrOptions() {
				var academicYear = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["academicYearForDate"])(new Date());
			...
			formOptions: function formOptions() {
				return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__modules_utils_js__["v" /* groupForms */])(this.subjectForms);
			},
			...
			evaluationDates: function evaluationDates() {
				...
				if (this.user.type === 'admin' && this.schedule) {
					...
					switch (form.evaluation_period_type) {
						case 'year':
							dates = [__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["currentYear"])()];
							break;
						case 'quarter':
							dates = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["quartersInAcademicYear"])().filter(function (quarter) {
								return quarter.startDate <= requestDate;
							});
							break;
						case 'month':
						default:
							dates = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["monthsInAcademicYear"])().filter(function (month) {
					...
					switch (form.evaluation_period_type) {
						case 'year':
							...
							if (today.month() === 6 && form.type === 'faculty') {
								dates.unshift(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["lastYear"])());
							}
							break;
						case 'quarter':
							dates = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["quartersInAcademicYear"])().filter(function (quarter) {
			...
			pendingFacultyEvalsConfig: function pendingFacultyEvalsConfig() {
				...
				return {
					...
					columns: [{ data: 'url', render: __WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["k" /* renderEvaluatorEvalUrl */] }, { data: 'subject.full_name' }, { data: 'form.title' }, {
						data: null,
						render: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["f" /* renderDateRangeCell */])('evaluation_date_start', 'evaluation_date_end'),
						createdCell: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["g" /* createDateRangeCell */])('evaluation_date_start', 'evaluation_date_end')
					}, { data: 'request_date', render: __WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["h" /* renderDateTimeCell */], createdCell: __WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["i" /* createDateTimeCell */] }, { data: null, render: function render(evaluation) {
			...
			completeFacultyEvalsConfig: function completeFacultyEvalsConfig() {
				return {
					...
					columns: [{ data: 'url', render: __WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["k" /* renderEvaluatorEvalUrl */] }, { data: 'subject.full_name' }, { data: 'form.title' }, {
						...
						render: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["f" /* renderDateRangeCell */])('evaluation_date_start', 'evaluation_date_end'),
						createdCell: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["g" /* createDateRangeCell */])('evaluation_date_start', 'evaluation_date_end')
					}, { data: 'request_date', render: __WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["h" /* renderDateTimeCell */], createdCell: __WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["i" /* createDateTimeCell */] }, { data: 'complete_date', render: __WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["h" /* renderDateTimeCell */], createdCell: __WEBPACK_IMPORTED_MODULE_8__modules_datatable_utils_js__["i" /* createDateTimeCell */] }],
					order: [[0, 'desc']],
					createdRow: function createdRow(row) {
						$(row).addClass('view-evaluation');
					}
