...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__milestones_competencies_js__ = __webpack_require__(394);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vue_components_DataTable_vue__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vue_components_OrderingList_vue__ = __webpack_require__(398);
	...
	return new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
		...
		computed: {
			milestonesThead: function milestonesThead() {
				return [['Title', 'Type', 'Subspecialty', 'Description', 'Action']];
			},
			milestonesConfig: function milestonesConfig() {
				return {
					...
					columns: [{ data: 'title' }, { data: 'type' }, { data: 'training_level' }, { data: 'description' }, { data: null, searchable: false, orderable: false, render: function render(milestone) {
			...
			competenciesConfig: function competenciesConfig() {
				return {
					...
					columns: [{ data: 'title' }, { data: 'description' }, { data: null, searchable: false, orderable: false, render: function render(competency) {
		...
		components: {
			...
			OrderingList: __WEBPACK_IMPORTED_MODULE_2__vue_components_OrderingList_vue___default.a
		}
	});
}
	...
	computed: {
		itemsRemaining: function itemsRemaining() {
			...
			return this.items.filter(function (item) {
				return !(_this.value.indexOf(item) !== -1);
			});
		}
	},
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("4b5d5ad8", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
