...
/***/ function(module, exports) {
	...
	var CHART_COLORS = exports.CHART_COLORS = ['#ff6384', '#4bc0c0', '#ffce56', '#e7e9ed', '#36a2eb', '#7eda35', '#462aa3', '#dd2727', '#f09113', '#1a7829'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AggregateReport = __webpack_require__(114);
	
	var _AggregateReport2 = _interopRequireDefault(_AggregateReport);
	
	var _ReportDate = __webpack_require__(107);
	
	var _ReportDate2 = _interopRequireDefault(_ReportDate);
	
	var _StatsReport = __webpack_require__(117);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChartjsChart = __webpack_require__(120);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('div', {
	    staticClass: "container body-block"
	  }, [_h('fieldset', [_m(0), " ", _l((show), function(part, name) {
		...
		props: {
			...
			defaultType: {
				...
				validator: function validator(value) {
					return ['line', 'bar', 'radar', 'polarArea', 'pie', 'doughnut', 'bubble'].indexOf(value) !== -1;
				}
			},
			data: {
				type: Object,
