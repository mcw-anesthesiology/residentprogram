...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_PhpDateInterval_vue__ = __webpack_require__(581);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_16a0d5eb_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_PhpDateInterval_vue__ = __webpack_require__(582);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_ComponentList_vue__ = __webpack_require__(564);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8543d20a_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_ComponentList_vue__ = __webpack_require__(573);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__news_js__ = __webpack_require__(550);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__case_overlaps_js__ = __webpack_require__(559);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vue_components_News_List_vue__ = __webpack_require__(551);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_List_vue__ = __webpack_require__(553);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_06b9a28c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_List_vue__ = __webpack_require__(558);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_errors_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_niceties_js__ = __webpack_require__(557);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_utils_js__ = __webpack_require__(1);
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vue_components_CaseOverlaps_CaseOverlap_vue__ = __webpack_require__(560);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vue_components_StartEndDate_vue__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__jacobmischka_vue_flatpickr__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__modules_text_utils_js__ = __webpack_require__(223);
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
function createCaseOverlaps(el, propsData) {
	return new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
		...
		data: function data() {
			...
			return {
				reportDatesStr: [params.get('startDate'), params.get('endDate')].join(' to '),
				reportDates: {
		...
		computed: {
			ready: function ready() {
				return this.user && this.pairings && this.reportDates.startDate && this.reportDates.endDate;
			}
		},
		mounted: function mounted() {
			this.fetchPairings();
		...
		watch: {
			reportDates: function reportDates() {
				this.fetchPairings();
			}
		},
		methods: {
			ucfirst: __WEBPACK_IMPORTED_MODULE_6__modules_text_utils_js__["h" /* ucfirst */],
			fetchPairings: function fetchPairings() {
				var _this = this;

				if (!(this.subjectType && this.reportDates.startDate && this.reportDates.endDate)) return;

				fetch('/reports/case-overlaps/pairings', Object.assign({}, Object(__WEBPACK_IMPORTED_MODULE_5__modules_utils_js__["g" /* fetchConfig */])(), {
					method: 'POST',
					body: JSON.stringify(Object.assign({}, this.reportDates, {
						subjectType: this.subjectType
					}))
				})).then(__WEBPACK_IMPORTED_MODULE_5__modules_utils_js__["w" /* jsonOrThrow */]).then(function (pairings) {
					_this.pairings = pairings;
				}).catch(function (err) {
					Object(__WEBPACK_IMPORTED_MODULE_4__modules_errors_js__["c" /* logError */])(err);
				});
			},
			handleReportDatesChange: function handleReportDatesChange(_ref) {
		...
		components: {
			CaseOverlap: __WEBPACK_IMPORTED_MODULE_1__vue_components_CaseOverlaps_CaseOverlap_vue__["a" /* default */],
			StartEndDate: __WEBPACK_IMPORTED_MODULE_2__vue_components_StartEndDate_vue__["a" /* default */],
			VueFlatpickr: __WEBPACK_IMPORTED_MODULE_3__jacobmischka_vue_flatpickr__["a" /* default */]
		}
	});
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_CaseOverlap_vue__ = __webpack_require__(562);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6494c294_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_CaseOverlap_vue__ = __webpack_require__(584);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ComponentList_vue__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PairingListItem_vue__ = __webpack_require__(574);
...
/* harmony default export */ __webpack_exports__["a"] = ({
		...
		fieldAccessors: function fieldAccessors() {
			return {
				...
				'time together': function timeTogether(pairing) {
					return Object(__WEBPACK_IMPORTED_MODULE_2__modules_date_utils_js__["parsePhpDateInterval"])(pairing.totalTime).asSeconds();
				}
			};
		}
	},
	...
	components: {
		...
		PairingListItem: __WEBPACK_IMPORTED_MODULE_1__PairingListItem_vue__["a" /* default */]
	}
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ListPaginator_vue__ = __webpack_require__(565);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lunr__ = __webpack_require__(572);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_ListPaginator_vue__ = __webpack_require__(567);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_55d164d3_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_ListPaginator_vue__ = __webpack_require__(571);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PaginatorLink_vue__ = __webpack_require__(568);
//
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_PaginatorLink_vue__ = __webpack_require__(569);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6166cb6b_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_PaginatorLink_vue__ = __webpack_require__(570);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_PairingListItem_vue__ = __webpack_require__(576);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_69b2a7d6_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_PairingListItem_vue__ = __webpack_require__(583);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__FallbackImg_vue__ = __webpack_require__(577);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PhpDateInterval_vue__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_errors_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_text_utils_js__ = __webpack_require__(223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_user_utils_js__ = __webpack_require__(155);
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	methods: {
		ucfirst: __WEBPACK_IMPORTED_MODULE_4__modules_text_utils_js__["h" /* ucfirst */],
		snakeCaseToWords: __WEBPACK_IMPORTED_MODULE_4__modules_text_utils_js__["f" /* snakeCaseToWords */],
		titleCase: __WEBPACK_IMPORTED_MODULE_4__modules_text_utils_js__["g" /* titleCase */],
		replaceAcronyms: __WEBPACK_IMPORTED_MODULE_4__modules_text_utils_js__["e" /* replaceAcronyms */],
		getSpecificType: __WEBPACK_IMPORTED_MODULE_5__modules_user_utils_js__["c" /* getSpecificType */],
		...
		cleanProcedureName: function cleanProcedureName(proc) {
			return Object(__WEBPACK_IMPORTED_MODULE_4__modules_text_utils_js__["e" /* replaceAcronyms */])(Object(__WEBPACK_IMPORTED_MODULE_4__modules_text_utils_js__["h" /* ucfirst */])(proc.toLowerCase()).replace(/,(?! )/g, ', '));
		},
		cleanAdditionalInfo: function cleanAdditionalInfo(text) {
			return Object(__WEBPACK_IMPORTED_MODULE_4__modules_text_utils_js__["e" /* replaceAcronyms */])(Object(__WEBPACK_IMPORTED_MODULE_4__modules_text_utils_js__["g" /* titleCase */])(text)).replace(/Or$/, 'OR');
		}
	},
	components: {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_FallbackImg_vue__ = __webpack_require__(578);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_17970841_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_FallbackImg_vue__ = __webpack_require__(579);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_text_utils_js__ = __webpack_require__(223);
//
//
//
//
            ...
            _c("small", [
              _vm._v(
                "\n\t\t\t" +
                  _vm._s(
                    _vm.renderDateRange(
                      _vm.reportDates.startDate,
                      _vm.reportDates.endDate
                    )
                  ) +
                  "\n\t\t"
              )
