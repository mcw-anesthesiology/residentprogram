...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_CaseLogs_vue__ = __webpack_require__(407);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6e2f1222_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_CaseLogs_vue__ = __webpack_require__(751);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_CaseLogs_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6e2f1222_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_CaseLogs_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] CaseLogs.vue: functional components are not supported with templates, they should use render functions.")}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_DataTable_vue__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4d4c1aff_hasScoped_true_node_modules_vue_loader_lib_selector_type_template_index_0_DataTable_vue__ = __webpack_require__(130);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4d4c1aff_hasScoped_true_node_modules_vue_loader_lib_selector_type_template_index_0_DataTable_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DataTable_vue__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ShowHideButton_vue__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Details_vue__ = __webpack_require__(655);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DetailsReport_vue__ = __webpack_require__(656);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__DetailsSchema_vue__ = __webpack_require__(657);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__modules_datatable_utils_js__ = __webpack_require__(21);
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	computed: {
		...
		tconfig: function tconfig() {
			...
			var columns = [{ data: 'id' }, { data: 'location.name' }, { data: 'case_date', render: __WEBPACK_IMPORTED_MODULE_7__modules_datatable_utils_js__["a" /* renderDateCell */], createdCell: __WEBPACK_IMPORTED_MODULE_7__modules_datatable_utils_js__["b" /* createDateCell */] }, { data: 'details_schema.details_type', render: function render(detailsType) {
						...
						methods: {
							deleteCaseLog: function deleteCaseLog() {
								fetch('/case_logs/' + caseLog.id, {
									method: 'POST', // DELETE
									headers: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__modules_utils_js__["b" /* getFetchHeaders */])(),
									credentials: 'same-origin',
									body: JSON.stringify({
										_method: 'DELETE'
									})
								}).then(__WEBPACK_IMPORTED_MODULE_8__modules_utils_js__["d" /* okOrThrow */]).then(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_case_log_details_schema_js__ = __webpack_require__(202);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	methods: {
		renderDetails: function renderDetails() {
			...
			}__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__modules_case_log_details_schema_js__["a" /* renderCaseLogDetailsSchema */])(this.caseLog.details_schema.schema, this.caseLog.details, this.$refs.schemaContainer);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_case_log_details_schema_js__ = __webpack_require__(202);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	methods: {
		renderReport: function renderReport() {
			...
			var report = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__modules_case_log_details_schema_js__["b" /* generateCaseLogDetailsReport */])(this.caseLogs);
			this.charts = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__modules_case_log_details_schema_js__["c" /* generateCaseLogDetailsReportCharts */])(report, name, this.$refs.statsContainer, this.charts);
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__modules_case_log_details_schema_js__["d" /* generateCaseLogLocationReportTable */])(report, name, this.$refs.statsContainer);
		}
	},
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	methods: {
		renderDetails: function renderDetails() {
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__modules_case_log_details_schema_js__["a" /* renderCaseLogDetailsSchema */])(this.schema, this.responses, this.$refs.container);
		}
	}
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vue_mixins_HasAlerts_js__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__vue_components_CaseLog_CaseLogs_vue__ = __webpack_require__(361);
	...
	return new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
		...
		computed: {
			...
			isAdmin: function isAdmin() {
				return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_utils_js__["a" /* userIsType */])(this.user, 'admin');
			},
		...
		methods: {
			fetchCaseLogs: function fetchCaseLogs() {
				...
				fetch('/case_logs?' + query, {
					headers: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_utils_js__["b" /* getFetchHeaders */])(),
					credentials: 'same-origin'
				}).then(__WEBPACK_IMPORTED_MODULE_7__modules_utils_js__["c" /* jsonOrThrow */]).then(function (caseLogs) {
			...
			deleteCaseLog: function deleteCaseLog(caseLogId) {
				...
				}).then(__WEBPACK_IMPORTED_MODULE_7__modules_utils_js__["d" /* okOrThrow */]).then(function () {
			...
			addCaseLog: function addCaseLog(event) {
				...
				fetch('/case_logs', {
					method: 'POST',
					headers: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_utils_js__["b" /* getFetchHeaders */])({ contentType: null }),
					credentials: 'same-origin',
					body: body
				}).then(__WEBPACK_IMPORTED_MODULE_7__modules_utils_js__["d" /* okOrThrow */]).then(function () {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Details_vue__ = __webpack_require__(408);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d6d68bfc_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Details_vue__ = __webpack_require__(768);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d6d68bfc_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Details_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_DetailsReport_vue__ = __webpack_require__(409);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4a5f0c54_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_DetailsReport_vue__ = __webpack_require__(743);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_DetailsReport_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4a5f0c54_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_DetailsReport_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] DetailsReport.vue: functional components are not supported with templates, they should use render functions.")}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_DetailsSchema_vue__ = __webpack_require__(410);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4cf55bc3_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_DetailsSchema_vue__ = __webpack_require__(744);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_DetailsSchema_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4cf55bc3_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_DetailsSchema_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] DetailsSchema.vue: functional components are not supported with templates, they should use render functions.")}
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.show.charts) ? _c('case-log-details-report', {
    attrs: {
      "case-logs": _vm.caseLogs
    }
  }) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "text-center"
  }, [_c('show-hide-button', {
    ...
    slot: "glyph"
  })], 2)], 1), _vm._v(" "), _c('data-table', {
    attrs: {
      "thead": _vm.thead,
      "config": _vm.tconfig,
      "data": _vm.caseLogs
    }
  }), _vm._v(" "), (_vm.detailsCaseLog) ? _c('case-log-details', {
    attrs: {
      "case-log": _vm.detailsCaseLog,
      "locations": _vm.locations
    },
    on: {
      "close": _vm.closeCaseLog
    }
  }) : _vm._e()], 1)
}
var staticRenderFns = []
...
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', {
    ...
    staticClass: "input-group date datetimepicker"
  }, [_c('input', {
