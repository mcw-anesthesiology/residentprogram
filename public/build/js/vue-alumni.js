...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Edit_vue__ = __webpack_require__(211);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9ec25dd4_hasScoped_true_node_modules_vue_loader_lib_selector_type_template_index_0_Edit_vue__ = __webpack_require__(299);
var disposed = false
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	methods: {
		...
		saveAlum: function saveAlum(event) {
			...
			}).then(__WEBPACK_IMPORTED_MODULE_2__modules_utils_js__["d" /* okOrThrow */]).then(function () {
				_this.$emit('reload');
			}).catch(function (err) {
				console.error(err);
				_this.$emit('alert', {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Subscription_vue__ = __webpack_require__(405);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8e5d72ae_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Subscription_vue__ = __webpack_require__(759);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	methods: {
		toggleSub: function toggleSub() {
			...
			fetch(this.saveUrl, {
				method: 'POST', // PATCH
				headers: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__modules_utils_js__["b" /* getFetchHeaders */])(),
				credentials: 'same-origin',
				body: JSON.stringify({
					_method: 'PATCH',
					do_not_contact: !this.alum.do_not_contact
				})
			}).then(__WEBPACK_IMPORTED_MODULE_0__modules_utils_js__["d" /* okOrThrow */]).then(function () {
				_this.$emit('reload');
			}).catch(function (err) {
				console.error(err);
				_this.$emit('alert', {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vue_components_Alumni_Edit_vue__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vue_components_Alumni_Subscription_vue__ = __webpack_require__(360);
		...
		methods: {
			reloadAlum: function reloadAlum() {
				...
				fetch('/alumni/hash/' + this.hash, {
					...
					credentials: 'same-origin'
				}).then(__WEBPACK_IMPORTED_MODULE_4__modules_utils_js__["c" /* jsonOrThrow */]).then(function (alum) {
					_this.alum = alum;
					_this.alerts.push({
						type: 'success',
