...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		...
		saveAlum: function saveAlum(event) {
			...
			}).then(__WEBPACK_IMPORTED_MODULE_2__modules_utils_js__["i" /* okOrThrow */]).then(function () {
				_this.$emit('reload');
			}).catch(function (err) {
				console.error(err);
				_this.$emit('alert', {
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		toggleSub: function toggleSub() {
			...
			}).then(__WEBPACK_IMPORTED_MODULE_0__modules_utils_js__["i" /* okOrThrow */]).then(function () {
				_this.$emit('reload');
			}).catch(function (err) {
				console.error(err);
				_this.$emit('alert', {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vue_components_Alumni_Edit_vue__ = __webpack_require__(202);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vue_components_Alumni_Subscription_vue__ = __webpack_require__(355);
