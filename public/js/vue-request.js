...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vue_components_DataTable_vue__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_indefinite__ = __webpack_require__(86);
		...
		computed: {
			...
			evaluationDates: function evaluationDates() {
				...
				if (form.evaluation_period_type === 'quarter') {
					dates = [__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["d" /* lastQuarter */])(), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["b" /* currentQuarter */])()];
				} else {
			...
			evaluationDateOptions: function evaluationDateOptions() {
				if (this.evaluationDates) return this.evaluationDates.map(function (date) {
					return {
						id: JSON.stringify(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["a" /* isoDateStringObject */])(date)),
						text: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__modules_date_utils_js__["i" /* renderDateRange */])(date.startDate, date.endDate)
					};
				});
			},
