...
import type twix$Twix from 'twix';

declare module 'moment' {
  declare export type moment$MomentOptions = {
    y?: number|string,
    year?: number|string,
    years?: number|string,
    M?: number|string,
  ...
  declare export type moment$MomentObject = {
    years: number,
    months: number,
    date: number,
    hours: number,
  ...
  declare export type moment$MomentCreationData = {
    input: string,
    format: string,
    locale: Object,
    isUTC: bool,
  ...
  declare export type moment$CalendarFormat = string | (moment: moment$Moment) => string;

  declare export type moment$CalendarFormats = {
  ...
  declare export type moment$Inclusivity = '()' | '[)' | '()' | '(]' | '[]'

  declare export class moment$LocaleData {
  ...
  declare export class moment$MomentDuration {
  ...
  declare export class moment$Moment {
    ...
    // Using twix, not sure how else to do this in flow
    twix(moment$Moment): twix$Twix;
  }
