        ...
        <table class="table">
          <tbody>
            <tr>
              ...
              <td>
                <div class="btn-group">
                  <button type="button" class="btn btn-default active" readonly="readonly">Yes</button>
                  <button type="button" class="btn btn-default" disabled="disabled">No</button>
                  <button type="button" class="btn btn-default" disabled="disabled">Did No Obesrve</button>
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <button type="button" class="btn btn-default" disabled="disabled">No</button>
                  <button type="button" class="btn btn-default active" readonly="readonly">Did No Obesrve</button>
                </div>
              </td>
            </tr>
          </tbody>
