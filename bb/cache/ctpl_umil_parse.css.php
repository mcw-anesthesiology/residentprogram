...
#page-header {
	background: url("<?php if ($this->_rootref['LOGO_IMG']) {  echo (isset($this->_rootref['LOGO_IMG'])) ? $this->_rootref['LOGO_IMG'] : ''; } else { echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>adm/images/phpbb_logo.png<?php } ?>") top left no-repeat;
}

.rtl #page-header {
	background: url("<?php if ($this->_rootref['LOGO_IMG']) {  echo (isset($this->_rootref['LOGO_IMG'])) ? $this->_rootref['LOGO_IMG'] : ''; } else { echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>adm/images/phpbb_logo.png<?php } ?>") top right no-repeat;
}
