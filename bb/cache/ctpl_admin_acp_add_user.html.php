...
//-->
	...
	<h1><?php echo ((isset($this->_rootref['L_ADD_USER'])) ? $this->_rootref['L_ADD_USER'] : ((isset($user->lang['ADD_USER'])) ? $user->lang['ADD_USER'] : '{ ADD_USER }')); ?> - <?php echo ((isset($this->_rootref['L_MOD_VERSION'])) ? $this->_rootref['L_MOD_VERSION'] : ((isset($user->lang['MOD_VERSION'])) ? $user->lang['MOD_VERSION'] : '{ MOD_VERSION }')); ?></h1>
