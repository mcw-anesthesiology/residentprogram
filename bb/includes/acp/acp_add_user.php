...
class acp_add_user
{
	...
	function email_new_user_x($indata){
	$message1 = "Your password for the MCW Milestones Evaluation System at residentprogram.com has been RESET.  Your new Milestones System password is: " . $indata['new_password'] . "\n\n"; 
	$message1.= "In addition, a new user account has been created for you on the MCW Anesthesiology Forum website - www.residentprogram.com/bb\n\n";
	$message1.= "The forum is intended to be a place where residents and faculty can freely discuss topics of interest, ranging from complex anesthetic cases to social events or links to high quality educational resources for studying.\n\n";
	$message1.= "Your MCW Anesthesiology Forum account is linked to your MCW ResidentProgram.com Milestones account.  When you log into the milestones evaluation system, you are automatically logged into the Forum too.  Just click the MCW Forum link at the top of any page on the Milestones Evaluation site in order to access the forum.\n";
	$message1.= "If you want to access the forum directly, you may access it at www.residentprogram.com/bb and log in using the same username and password as your Milestones Evaluation System account.\n\n";
	$message1.= "IMPORTANT: Your password for BOTH the MCW Forum and your Milestones account have been reset in the process of creating a forum account for you.  Your new Milestones and MCW Forum passwords are listed below:\n\n";
	$message1.= "Username: " . $indata['username'] . "\n";
	$message1.= "Password: " . $indata['new_password'] . "\n\n";
	$message1.= "Changing your password for the Forum or the Milestones site in the future will also change your password for the other program; the passwords are permanently linked together for ease of access.\n\n";
	$message1.= "===FROEDTERT AND VA COMPUTERS MAY HAVE PROBLEMS ACCESSING THE MILESTONES WEBSITE===\n";
	$message1.= "We have discovered a problem accessing the site from Froedtert-owned computers (and possibly from VA-owned computers) due to both hospitals using old versions of Internet Explorer as their primary web browser.  We recommend using a personal laptop, iphone, ipad, or other device to access the system for the time-being.  CHW and St. Joes do not seem to be affected by the problem.  We are working to fix the problem as quickly as possible.\n";
	$message1.= "Please email me if you have any questions or difficulty accessing either the Milestones system or the Forum.\n\nI hope you find the new systems both intuitive and useful.\nRegards,\nKevin Jenner\nkjenner@mcw.edu";
	$to = $indata['email'];
	$subject = "Important: Milestones Account Password Reset (residentprogram.com) and NEW MCW Forum account created";
	$headers = "From: eval_system@residentprogram.com\r\nX-Mailer: PHP/" . phpversion();
	if(mail($to,$subject,$message1,$headers)){ print "Made it.";} else{ print "Failed.";}
	}
